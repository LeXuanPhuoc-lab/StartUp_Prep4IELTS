...
public class CreatePremiumPackageRequest
{
    ...
    [Range(minimum: 1, maximum: int.MaxValue, ErrorMessage = "Please enter a value bigger than 1.")]
    ...
    [Range(minimum: 2000, maximum: int.MaxValue, ErrorMessage = "Please enter a price bigger than 2000VND.")]
